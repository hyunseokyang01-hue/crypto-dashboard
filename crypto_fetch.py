...
def fetch_stable_stocks(stocks=STABLE_STOCKS):
    """크립토 관련주 시세 — yfinance. COIN/HOOD/CRCL.
    반환: [{"티커","이름","현재가","전일대비%"}]"""
    out = []
...
'@ | Out-File -FilePath crypto_fetch.py -Encoding utf8
